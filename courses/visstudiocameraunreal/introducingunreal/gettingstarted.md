...
<a href="https://www.youtube.com/embed/ewRKuI49vPQ?start=177&autoplay=1" target="embed" allow="autoplay" onclick="document.getElementById('[02:57]').scrollIntoView({ behavior: 'smooth', block: 'nearest', inline: 'nearest' });" >[02:57]</a>  ||  
...
<div style="height: 400px; margin-left:50%; overflow: scroll;">
